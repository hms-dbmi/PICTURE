...
from src.models.natpn.datasets import DataModule, OutputType
from src.models.natpn.nn import CertaintyBudget, NaturalPosteriorEnsembleModel, NaturalPosteriorNetworkModel
from src.models.natpn.nn.encoder import (
    DeepImageEncoder,
    DenseDepthEncoder,
    ResnetEncoder,
    ShallowImageEncoder,
...
from src.models.natpn.nn.flow import MaskedAutoregressiveFlow, RadialFlow
...
EncoderType = Literal["tabular", "image-shallow", "image-deep", "resnet", "dense-depth", "vit"]
"""
...
class NaturalPosteriorNetwork(BaseEstimator):
    ...
    def _init_model(
        ...
        if self.encoder == "tabular":
            ...
            encoder = ViT8(latent=self.latent_dim)

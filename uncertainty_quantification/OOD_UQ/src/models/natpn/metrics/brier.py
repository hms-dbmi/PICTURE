...
class BrierScore(torchmetrics.Metric):
    ...
    def __init__(self, compute_on_step: bool = True, dist_sync_fn: Any = None, full_state_update: bool = False):
        super().__init__(compute_on_step=compute_on_step, dist_sync_fn=dist_sync_fn, full_state_update = full_state_update)

...
from src.datasets.extra_ood import ExtraOodDataset
import albumentations as A
from albumentations.pytorch import ToTensorV2


class ExtraOodDatamodule(LightningDataModule):
    ...
    def __init__(
        self,
        slides_file: str = "/n/data2/hms/dbmi/kyu/lab/jz290/Ebrains-Control/tile_datasets/testing_SY_1000dense_max500_Q0.95_Zoom20X",

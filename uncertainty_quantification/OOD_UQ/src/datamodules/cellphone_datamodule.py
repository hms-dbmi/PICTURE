...
class CellphoneDataModule(LightningDataModule):
    ...
    def __init__(
        self,
        slides_file: str = "/n/data2/hms/dbmi/kyu/lab/jz290/cell-phone/RCC_BWH_photo.hdf5",
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        if not self.data_train and not self.data_val and not self.data_test:
            dataset = CellphoneDataset(slides_file=self.hparams.slides_file, target_transform = self.target_transform, transform= self.transforms, dino = self.hparams.dino)

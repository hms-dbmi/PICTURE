...
class ViennaDataset(Dataset):
    def __init__(
        ...
        self.dino = dino
        self.dict_path_labels = self.find_jpeg(slides_file, filter_file=filter_file)
    ...
    def find_jpeg(self, path, labels: list = ["Ebrain_GBM", "Ebrain_PCNSL"],filter_file=None):
                        ...
                        dict_path_labels.append(
                            {
                                ...
                                "patient_id": os.path.splitext(os.path.basename(root))[
                                    0
                                ],
                            }
                        )

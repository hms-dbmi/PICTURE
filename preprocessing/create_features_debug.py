...
from utils.transforms import get_transforms, TorchBatchMacenkoNormalizer
...
def process_tiles_pt(args, slide_id: str, models: Dict[str, nn.Module], progress=0):
    ...
    if len(all_files) > 1:
        ...
        raise Warning(f"Multiple WSI files found in {args.wsi_folder}, using the first one")
...
def main():
    ...
    process_tiles_pt(args, slide_id, models, progress=0)
